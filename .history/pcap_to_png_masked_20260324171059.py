...
def main() -> None:
    ...
    count = 0
    for cap_file in tqdm(files, desc="Converting pcap to png", unit="file"):
        ...
        count += 1
        # Keep only the global tqdm progress bar by default.
        # Per-file logs are intentionally suppressed.
